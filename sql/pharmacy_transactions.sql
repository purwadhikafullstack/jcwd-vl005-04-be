...
CREATE TABLE `transactions` (
  ...
  `transaction_statuses_id` tinyint DEFAULT NULL,
  ...
  KEY `transaction_statuses_id` (`transaction_statuses_id`),
  CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `transactions_ibfk_2` FOREIGN KEY (`address_id`) REFERENCES `user_addresses` (`id`),
  CONSTRAINT `transactions_ibfk_3` FOREIGN KEY (`transaction_statuses_id`) REFERENCES `transaction_statuses` (`id`)
